...
std::string segunda_passagem(std::string linha, std::unordered_map<std::string, int>& tabela_simbolos, int& pos_PC){
  ...
  std::string arg1;
  std::string arg2;
  int codigo_simbolo,cod_1, cod_2;
  ...
  cod_2 = busca_codigo_arg(arg2, tabela_simbolos);

  //std::cout << std::endl << std::endl << simb << arg1 << arg2 << std::endl << std::endl;
  ...
  switch(simb){
    ...
    case SIMB_RET:
      ...
      break;
    case SIMB_LOAD:
      codigo << codigo_simbolo << " " << cod_1 << " " << arg2 << " ";
      break;
    case SIMB_STORE:
      codigo << codigo_simbolo << " " << cod_1 << " " << (cod_2 - pos_PC) << " ";
      break;
    case SIMB_READ:
    case SIMB_WRITE:
    case SIMB_PUSH:
    ...
    case SIMB_AND:
    case SIMB_OR:
      codigo << codigo_simbolo << " " << cod_1 << " " << cod_2 << " ";
      break;
    case SIMB_JUMP:
    case SIMB_JZ:
    case SIMB_JN:
